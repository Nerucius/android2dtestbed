package edu.ub.pis2016.german.testbed.engine.android;
...
import edu.ub.pis2016.german.testbed.engine.framework.Input.TouchEvent;
import edu.ub.pis2016.german.testbed.engine.util.Pool;
import edu.ub.pis2016.german.testbed.engine.framework.TouchHandler;
		...
		synchronized (this) {
			...
			for (int i = 0; i < MAX_TOUCHPOINTS; i++) {
				...
				if (event.getAction() != MotionEvent.ACTION_MOVE && i != pointerIndex) {
					...
					// if we should process it for this orig
					continue;
				}
				switch (action) {
